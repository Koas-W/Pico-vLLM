...
def plot_results(results, save_path="profile_paged.png"):
    ...
    fig.suptitle('Paged KV Cache Inference Profiling (Gather)', fontsize=14)
...
if __name__ == "__main__":
    ...
    with open("profile_paged.json", "w") as f:
        json.dump(results, f, indent=2)
    print(f"\n数据已保存到 profile_paged.json")
